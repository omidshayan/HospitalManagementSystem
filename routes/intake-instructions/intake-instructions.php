...
uri('edit-intake-instructions-store/{id}', 'App\IntakeInstructions', 'editIntakeInstructions', 'POST');
uri('dosage-intake-instructions/{id}', 'App\IntakeInstructions', 'intakeInstructionsDetails');
