...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت وظایف
    ...
    <!-- show packages -->
    <div class="box-container">
        <div class="mb10 fs14"> وظایف ثبت شده</div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-position/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('position-details/' . $item['id']) ?>">
