...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت نوع دارو
    ...
    <div class="mini-container">
        <div class="insert">
            <form id="myForm" action="<?=url('drug-type-store')?>" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نوع دارو <?= _star ?> </div>
                        <input type="text" name="drug_type" class="checkInput" placeholder="نوع دارو را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-dosage/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('dosage-details/' . $item['id']) ?>">
