...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت دپارتمنت
    ...
    <!-- show packages -->
    <div class="mini-container">
        <div class="mb10 fs14"> دپارتمنت‌های ثبت شده</div>
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($departments, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $item['name'] ?></td>
                        <td>
                            <a href="<?= url('edit-department/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('department-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($departments) ?></div>
            <?php
            if (count($departments) == null) { ?>
            ...
            <?php } else {
                if (count($departments) > 10) {
                    echo paginateView($departments, 10);
                }
            }
            ?>
        </div>
