...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت تولید کننده‌ها
    ...
    <div class="mini-container">
        <div class="insert">
            <form id="myForm" action="<?=url('company-store')?>" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام / کشور تولید کننده <?= _star ?> </div>
                        <input type="text" name="name" class="checkInput" placeholder="نام یا کشور تولید را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
    ...
    <!-- show packages -->
    <div class="mini-container">
        <div class="mb10 fs14"> آیتم‌های ثبت شده</div>
        <table class="fl-table">
            <thead>
                <tr>
                    <th>#</th>
                    <th>نام / کشور تولید کننده</th>
                    <th>ویرایش</th>
                    <th>جزئیات</th>
                </tr>
            </thead>
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($companies, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $item['name'] ?></td>
                        <td>
                            <a href="<?= url('edit-company/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('company-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($companies) ?></div>
            <?php
            ...
            <?php } else {
                if (count($companies) > 10) {
                    echo paginateView($companies, 10);
                }
            }
            ?>
        </div>
