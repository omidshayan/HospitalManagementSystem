...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت مقدار مصرف
    ...
    <div class="mini-container">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($dosage) ?></div>
            <?php
            if (count($dosage) == null) { ?>
