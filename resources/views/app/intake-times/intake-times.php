...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت زمان مصرف
            ...
            <form id="myForm" action="expense-cat-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        ...
                        <input type="text" name="intake_times" class="checkInput" placeholder="زمان مصرف را وارد نمایید" autocomplete="off" />
                    </div>
                </div>
    ...
    <div class="mini-container">
        ...
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($intakeTimes, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('intake-time-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($intakeTimes) ?></div>
            <?php
            if (count($intakeTimes) == null) { ?>
                <div class="center color-red fs12">
                    <i class="fa fa-comment"></i>
                    <?= _not_infos ?>
                </div>
            <?php } else {
                if (count($intakeTimes) > 10) {
                    echo paginateView($intakeTimes, 10);
                }
            }
            ?>
        </div>
