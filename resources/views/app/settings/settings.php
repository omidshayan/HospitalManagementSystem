...
<div class="content">
        ...
        <div class="allow-invoice d-flex justify-between mt15">
            <span>
                ...
                <span class="tool-c">
                    ...
                    <div class="tool-t">
                        این قسمت برای مطب و کلینیک‌هایی است که تنها یک داکتر دارن یا میخواهند نسخه جدید در همان اتاق داکتر چاپ شود.
    ...
    <div class="mini-container">
        <div class="fs14 color-green">تنظیمات ثبت نسخه جدید</div>
        <hr class="hr">

        <!-- drug type doctor panel -->
        <div class="allow-invoice d-flex justify-between mt20">
            <span>
                نمایش نوع دارو
                ...
                <span class="tool-c">
                    ...
                    <div class="tool-t">
                        با غیرفعال کردن این قسمت، بخش نوع دارو نمایش داده نمی شود.
                    </div>
                </span>
            </span>
            <label class="m-switch">
        ...
        <div class="allow-invoice d-flex justify-between mt20">
            <span>
                نمایش بخش تولید کننده
                <span id="company" class="status-text <?= ($settings['company'] == 1) ? 'color-green' : 'color-orange' ?>">
                    (<?= ($settings['company'] == 1) ? 'فعال' : 'غیر فعال' ?>)
                </span>
                <span class="tool-c">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    ...
                    <div class="tool-t">
                        با غیرفعال کردن این قسمت، بخش تولید کننده نمایش داده نمی شود.
                    </div>
                </span>
            </span>
            <label class="m-switch">
        ...
        <div class="allow-invoice d-flex justify-between mt20">
            <span>
                نمایش بخش توضیحات
                <span id="description" class="status-text <?= ($settings['description'] == 1) ? 'color-green' : 'color-orange' ?>">
                    (<?= ($settings['description'] == 1) ? 'فعال' : 'غیر فعال' ?>)
                </span>
                <span class="tool-c">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    ...
                    <div class="tool-t">
                        با غیرفعال کردن این قسمت، بخش توضیحات نمایش داده نمی شود.
                    </div>
                </span>
            </span>
            <label class="m-switch">
                <input
                    ...
                    data-true-class="color-green"
                    data-false-class="color-orange"
                    <?= ($settings['description'] == 1) ? 'checked' : '' ?>>
                <span class="m-slider"></span>
            </label>
        </div>
        ...
        <div class="allow-invoice d-flex justify-between mt20">
            <span>
                نمایش بخش آزمایش‌ها
                <span id="tests" class="status-text <?= ($settings['tests'] == 1) ? 'color-green' : 'color-orange' ?>">
                    (<?= ($settings['tests'] == 1) ? 'فعال' : 'غیر فعال' ?>)
                </span>
                <span class="tool-c">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    ...
                    <div class="tool-t">
                        با غیرفعال کردن این قسمت، بخش آزمایش‌ها نمایش داده نمی شود.
                    </div>
                </span>
            </span>
            <label class="m-switch">
