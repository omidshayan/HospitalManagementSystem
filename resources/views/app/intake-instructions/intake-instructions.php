...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت طریقه مصرف
    ...
    <div class="mini-container">
        ...
        <table class="fl-table">
            ...
            <tbody>
                <?php
                $perPage = 10;
                $data = paginate($intakeInstructions, $perPage);
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('intake-instructions-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            ...
            <?php
            if (count($intakeInstructions) == null) { ?>
                <div class="center color-red fs12">
                    <i class="fa fa-comment"></i>
                    <?= _not_infos ?>
                </div>
            <?php } else {
                if (count($intakeInstructions) > 10) {
                    echo paginateView($intakeInstructions, 10);
                }
            }
            ?>
        </div>
