...
admin
      ...
      <div class="sidebar-item">
        <ul>
          ...
          <!-- payment slip -->
          <li class="sidebar-menu">
            <a href="<?= url('payment-slip') ?>" class="d-flex align-center justify-between">
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w17" viewBox="0 0 16 16">
                  <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z" />
                </svg>
                <span class="mr5">فیش پرداخت</span>
              </span>
            </a>
          </li>
          ...
          <?php if ($this->hasAccess('general')): ?>
            <li class="sidebar-menu ri-dashboard-line sidebar-menu-item has-dropdown">
              ...
              <ul class="sidebar-dropdown-menu">
                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('add-sale') ?>">
                    <li class="sidebar-dropdown-menu-item">ثبت فاکتور فروش <span class="fs14">(F5)</span></li>
                  </a>
                <?php endif; ?>
              ...
              <ul class="sidebar-dropdown-menu">
                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('add-product-inventory') ?>">
                    <li class="sidebar-dropdown-menu-item">ثبت فاکتور خرید</li>
                  </a>
                <?php endif; ?>

                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('purchase-invoices') ?>">
                    <li class="sidebar-dropdown-menu-item">نمایش فاکتورهای خرید</li>
                  </a>
                <?php endif; ?>
                <?php if ($this->hasAccess('general')): ?>
