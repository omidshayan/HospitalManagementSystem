    <!-- start sidebar -->
    <?php
    $title = 'جزئیات دپارتمنت: ' . $department['name'];
        ...
        <div class="mini-container">
            ...
            <div class="details">
                <div class="detail-item d-flex">
                    ...
                    <div class="w100 m10 center"><?= $department['employee_name'] ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">ساخته شده توسط</div>
                    <div class="w100 m10 center"><?= $department['who_it'] ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">تاریخ ساخت</div>
                    <div class="w100 m10 center"><?= jdate('Y/m/d', strtotime($department['created_at'])) ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">
                        ...
                        <div class="w100 m10 center">
                            <td>
                                <a href="#" data-url="<?= url('change-status-department') ?>" data-id="<?= $department['id'] ?>" class="changeStatus color btn p5 w100 m10 center">تغییر وضعیت</a>
                            </td>
                        </div>
                    </div>
