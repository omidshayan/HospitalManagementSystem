...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت آزمایشات
        <span class="help fs14 text-underline cursor-p color-orange" id="openModalBtn">(راهنما)</span>
    </div>
    <?php
    $help_title = 'راهنمای بخش مدیریت ازمایشات';
    $help_content = 'در این قسمت اطلاعات مدیریت ازمایشات اضافه می شود ';
    include_once('resources/views/helps/help.php');
    ?>
    <!-- start page content -->
    <div class="mini-container">
        <div class="insert">
            <form id="myForm" action="test-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام آزمایش <?= _star ?> </div>
                        <input type="text" name="test_name" class="checkInput" placeholder="نام آزمایش را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
    ...
    <!-- show packages -->
    <div class="mini-container">
        <div class="mb10 fs14"> آزمایشات ثبت شده</div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('edit-test/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('test-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($tests) ?></div>
            <?php
            if (count($tests) == null) { ?>
