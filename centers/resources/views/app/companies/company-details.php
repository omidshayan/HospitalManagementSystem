    <!-- start sidebar -->
    <?php
    $title = 'جزئیات تولید کننده: ' . $company['name'];
    ...
    <!-- Start content -->
    <div class="content">
        <div class="content-title"> جزئیات تولید: <?= $company['name'] ?></div>
        <!-- start page content -->
        <div class="mini-container">
            <div class="details">
                <div class="detail-item d-flex">
                    <div class="w100 m10 center">نام کشور / تولید کننده</div>
                    <div class="w100 m10 center"><?= $company['name'] ?></div>
                </div>
            </div>
            <div class="details">
                <div class="detail-item d-flex">
